...
El proyecto esta hecho en Visual studio comunity 2022, se enviara un archivo *.ZIP* para el funcionamiento del proyecto y su correcto funcionamiento, para su correcta compilación se debe abrir el arcihivo "Damas.sln".
